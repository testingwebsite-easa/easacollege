    ...
    },
    {
        ...
        subCriteria: [
            ...
            },
            {
                ...
                title: "Criterion 2.7",
                items: [
                    { metric: "2.7.1", parameter: "Online student satisfaction survey regarding to teaching learning process. (Online survey to be conducted)", link: "https://easa-college.s3.eu-north-1.amazonaws.com/assets/naac/criterion-2/2.7.1/2.7.1-index.pdf" }
                ]
            }
        ]
    },
    {
        ...
        subCriteria: [
            ...
            },
            {
                ...
                title: "Criterion 3.2",
                items: [
                    { metric: "3.2.1", parameter: "Institution has created an ecosystem for innovations and has initiatives for creation and transfer of knowledge(patents filed, published, incubation center facilities in the HEI to be considered)", link: "https://easa-college.s3.eu-north-1.amazonaws.com/assets/naac/criterion-3/3.2.1/viewpage.pdf" },
            ...
            },
            {
                ...
                items: [
                    ...
                    { metric: "3.4.3", parameter: "Number of extension and outreach programs conducted by the institution through NSS/NCC/Red cross/YRC etc., (including the programmes such as Swachh Bharat, AIDS awareness, Gender issues etc. and/or those organised in collaboration with industry, community and NGOs) during the last five years", link: "https://easa-college.s3.eu-north-1.amazonaws.com/assets/naac/criterion-3/3.4.3/viewpage.pdf" }
                ]
            },
            {
                id: "3.5",
        ...
        <div className="naac-page">
            ...
            <section className="scroll-menu-container">
                <ul className="scroll-menu-list">
                    <li><a href="https://easa-college.s3.eu-north-1.amazonaws.com/assets/naac/ssr.pdf" target="_blank" rel="noreferrer">SSR</a></li>
